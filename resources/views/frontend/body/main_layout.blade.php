...
<body class="home blog" oncontextmenu="return true" data-new-gr-c-s-check-loaded="14.1078.0" data-gr-ext-installed="">
    ...
    <div class="main_website">
        ...
        @include('frontend.body.header_bar')

        @include('frontend.body.header_menu')

        @include('frontend.body.header_marquee')
    ...
    <script src="{{ asset('frontend/assets/js/regenerator-runtime.min.js') }}" id="regenerator-runtime-js"></script>
    <script src="{{ asset('frontend/assets/js/wp-polyfill.min.js') }}" id="wp-polyfill-js"></script>
